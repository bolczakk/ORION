...
extern osSemaphoreId_t oled_sem;
...
void HAL_SPI_TxCpltCallback(SPI_HandleTypeDef *hspi) {
	// ZMIEŃ SPI1 na numer SPI, pod którym masz ekran (np. SPI4, SPI5)
	if (hspi->Instance == SPI1) {
		// Dajemy sygnał do FreeRTOS, że ekran został narysowany
		OLED_CS_1;
		osSemaphoreRelease(oled_sem);
	}
}
