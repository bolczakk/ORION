...
// UWAGA NA #define INTERFACE_THREAD_STACK_SIZE ( 500 ) !!! WARTOSC 500 TO MINIMUM, DOMYSLNA WARTOSC GENEROWANA PRZEZ CUBEMX JEST ZA MALA!!!
...
void ethernetif_input(void *argument) {
	...
	for (;;) {
		if (osSemaphoreAcquire(RxPktSemaphore, TIME_WAITING_FOR_INPUT)
				== osOK) {
			do {
